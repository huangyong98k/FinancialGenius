...
$(function(){
    ...
    $(function(){
        var data = [
            {name : '1~3月',value :32.5,color:'#4572a7'},
            {name : '4~6月',value : 34.3,color:'#aa4643'},
            {name : '7~12月',value : 8.4,color:'#89A54E'},
            {name : '12~24月',value : 3.6,color:'#80699b'},
            {name : '24月以上',value : 6.2,color:'#3d96ae'}
        ];
