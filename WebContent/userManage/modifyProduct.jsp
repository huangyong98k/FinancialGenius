				...
				<form action="productAction!do_edit" method="post">
					<div class="baBody">
						...
						<div class="bbD">
							...
							<input type="text" class="input3" name="product.productRate" /> <img
								id="img_ok" src="imgs/ok.png"><img id="img_no"
								src="imgs/no.png"> <span id="text_no"></span>
						</div>
						<div class="bbD">
