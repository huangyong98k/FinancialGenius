    ...
    <div class="menu-card-2 topnav" id="topnav" style="position: relative;">
        <div style="overflow:auto;">
            <div class="menu-bar menu-left" style="width:100%;overflow:hidden;">
                ...
                <a class="menu-bar-item menu-button " title="网贷投资" id="investment" href="statistics/dataStatistics.html" target="mainFrame">数据统计</a>
                <a class="menu-bar-item menu-button" title="理财产品" id="financial-product" href="products/commodityList.html" target="mainFrame">理财产品</a>
                <a class="menu-bar-item menu-button" title="已购产品" id="buy-product" href="products/buyList.html" target="mainFrame">已购产品</a>
            </div>
        </div>
    </div>
    <div id="maindiv">
